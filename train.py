...
from utils import RandomDataset, load_Phi, compute_initialization_matrix, psnr, ssim
...
parser.add_argument('--init', type=bool, default=False, help='initialization True by default')
...
for PhaseNo in range(start_phase, end_phase+1, 2):
    ...
    for epoch_i in range(start_epoch+1, end_epoch+1):
        ...
        for data in rand_loader:
            ...
            psnr_value=psnr(x_output,batch_x)

            print(f'Test Results - PSNR: {psnr_value:.2f}dB')
